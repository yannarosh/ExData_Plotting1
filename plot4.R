makeplot4 <- function() {
        ...
        if(!file.exists("./data")) {
                ...
                legend("topright", lty = 1, lwd = 2, col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), cex = 0.85, bty = "n")
                
                plot(Asub$Global_reactive_power ~ Asub$DateTime, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
